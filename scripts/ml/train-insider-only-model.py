#!/usr/bin/env python3
"""
Train Smart Money Flow Model - Insider Features Only (4 Features)
...
Usage:
    python3 scripts/ml/train-insider-only-model.py
"""
...
# Paths
DATA_DIR = "data/training/smart-money-flow"
MODEL_DIR = "models/smart-money-flow/v1.0.0-insider-only"
TRAIN_FILE = f"{DATA_DIR}/train.csv"
VAL_FILE = f"{DATA_DIR}/val.csv"
TEST_FILE = f"{DATA_DIR}/test.csv"

# Feature names (4 insider features)
FEATURE_NAMES = [
    "insider_buy_volume_30d",
    "insider_sell_volume_30d",
    "insider_buy_ratio_30d",
...
def save_model(model, means, stds, train_metrics, val_metrics, test_metrics):
    ...
    metadata = {
        ...
        'model_version': 'v1.0.0-insider-only',
...
def plot_feature_importance(feature_importance_list):
    ...
    plt.title('Smart Money Flow - Feature Importance (4 Insider Features)')
    plt.tight_layout()
...
def main():
    ...
    print("=" * 80)
    print("Smart Money Flow Model Training (4 Insider Features)")
    print("=" * 80)
