...
function testLabelGeneration() {
  ...
  console.log(`Change: ${(tslaFutureScore - tslaCurrentScore).toFixed(4)} (${tslaChange.toFixed(2)}%)`)
  ...
  console.log(`Change: ${(neutralFutureScore - neutralCurrentScore).toFixed(4)} (${neutralChange.toFixed(2)}%)`)
  ...
  console.log('-'.repeat(80))
  console.log(`Current consensus: ${downgradeCurrentScore.toFixed(4)} (${downgradeToday.consensus})`)
  console.log(`Future consensus: ${downgradeFutureScore.toFixed(4)} (${downgradeFuture.consensus})`)
  console.log(`Change: ${(downgradeFutureScore - downgradeCurrentScore).toFixed(4)} (${downgradeChange.toFixed(2)}%)`)
