...
(async () => {
	...
	await page.screenshot({
		path: "docs/project/screenshots/screenshot-baseline-initial.png",
		fullPage: true,
	});
	...
	await page.screenshot({
		path: "docs/project/screenshots/screenshot-baseline-with-industry.png",
		fullPage: true,
	});
	...
	await dropdownElement.screenshot({
		path: "docs/project/screenshots/screenshot-baseline-dropdown-zoom.png",
	});
	...
	await page.screenshot({
		path: "docs/project/screenshots/screenshot-after-adjustments.png",
		fullPage: true,
	});

	// Take a zoomed-in screenshot of the adjusted dropdown
	const adjustedDropdown = await page.locator(".sector-dropdown");
	await adjustedDropdown.screenshot({
		path: "docs/project/screenshots/screenshot-after-dropdown-zoom.png",
	});
