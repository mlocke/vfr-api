...
global.setTimeout = (fn, delay, ...args) => {
  ...
  const adjustedDelay = process.env.PERFORMANCE_TEST_MODE === 'true'
    ? Math.min(delay, 1000)
    : delay
...
console.log(`🎯 Cache hit rate target: ${Math.round(global.PERFORMANCE_CONFIG.CACHE_HIT_RATE_TARGET * 100)}%`)