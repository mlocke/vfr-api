...
export default function StockIntelligencePage() {
	...
	const handleSymbolSelectionChange = (symbols: string[]) => {
		...
		const symbolsChanged =
			JSON.stringify(symbols.sort()) !== JSON.stringify(selectedSymbols.sort());
	...
	const isAnalysisReady =
		(analysisType === "sector" && selectedSector) ||
			...
			<div className="main-container" style={{ marginTop: "120px" }}>
				...
				<section style={{ padding: "2rem 1rem", position: "relative", zIndex: 2 }}>
					<div style={{ maxWidth: "1200px", margin: "0 auto" }}>
						...
						>
							...
							>
								Choose a sector or enter specific stock tickers for comprehensive
								market analysis
							</p>
						</div>
						...
						<div style={{ textAlign: "center", marginBottom: "2rem" }}>
							<button
								...
								style={{
									...
									fontWeight: "700",
									cursor:
										isAnalysisReady && !isAnalyzing ? "pointer" : "not-allowed",
									transition: "all 0.3s ease",
									boxShadow:
						...
						<AnalysisResults results={results} error={error} isRunning={isAnalyzing} />
					</div>
				</section>
				...
				<footer className="footer">
					...
					<p style={{ marginTop: "1rem", fontSize: "0.85rem", opacity: 0.8 }}>
						Stock Intelligence tools are provided for educational purposes only and
