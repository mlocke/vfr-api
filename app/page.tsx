			...
			<div className="main-container" style={{ marginTop: "120px" }}>
				<header className="header">
					<div className="logo">
						...
						<div className="logo-text-container">
							<div className="logo-text prominent-logo-text">
					...
					<p className="tagline">
						Comprehensive Financial Analysis & Market Intelligence Platform
					</p>
				</header>
					...
					<div className="hero-content">
						<div className="hero-text">
							...
							<p className="hero-subtitle">
								...
								learning to make informed investment decisions. Veritak's platform
								aggregates data from government sources, commercial APIs, and web
								intelligence to deliver comprehensive financial research and market
								intelligence.
							</p>
				...
				<section className="data-engines-section">
					<div className="data-engines-container">
						<div className="data-engines-header">
							<h2 className="data-engines-title">
								Powered by 13 Financial Data Sources
							</h2>
							<p className="data-engines-subtitle">
								Institutional-grade data sources across the entire financial
								ecosystem
							</p>
						</div>
								...
								<div className="data-sources-grid">
									...
									<div className="data-source-card premium">
										...
										<div className="source-info">
											...
											<p className="source-desc">
												100K req/day, fundamental ratios
											</p>
										</div>
										<div className="source-status live"></div>
									</div>
						...
						<p className="disclaimer">
							...
							licensed financial data providers. All analysis is provided for
							educational and informational purposes only and should not be considered
							as investment advice. Past performance does not guarantee future
							results.
						</p>
					</div>
				</section>
						...
						<div className="features-grid">
							<div className="feature-card">
								...
								<h3 className="feature-title">
									50+ Technical Indicators & Pattern Recognition
								</h3>
								<p className="feature-description">
									Real-time RSI, MACD, Bollinger Bands, Moving Averages, and
									momentum signals. Automatic trend detection and chart pattern
									recognition through SimpleTechnicalTestService.
								</p>
							</div>
							<div className="feature-card">
								<div className="feature-icon">🤖</div>
								<h3 className="feature-title">
									Options Sentiment & Put/Call Analysis
								</h3>
								<p className="feature-description">
							...
							<div className="feature-card">
								...
								<p className="feature-description">
									Modern Portfolio Theory implementation with risk-adjusted
									returns. Automated rebalancing alerts and position sizing
									recommendations.
								</p>
							</div>
						</div>
				...
				<footer className="footer">
					...
					<p style={{ marginTop: "1rem", fontSize: "0.85rem", opacity: 0.8 }}>
						Veritak Financial Research LLC provides analysis tools for educational
						purposes. All investment decisions should be made in consultation with
						qualified financial advisors. Past performance does not guarantee future
						results.
					</p>
				</footer>
			</div>
