...
describe.skip('TechnicalIndicatorService Options Integration (Core) - SKIPPED: Methods need updating', () => {
  ...
  describe('Core Integration', () => {
    it('should maintain backward compatibility when options service unavailable', async () => {
      ...
      console.log(`Breakdown: Trend: ${result.score?.breakdown.trend}, Momentum: ${result.score?.breakdown.momentum}, Volume: ${result.score?.breakdown.volume}, Patterns: ${result.score?.breakdown.patterns}`)
    })
