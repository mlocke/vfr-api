...
import { Pool } from 'pg'
import { TrainingOrchestrator, TrainingJobConfig, RetrainingSchedule } from '../TrainingOrchestrator'
...
describe('TrainingOrchestrator', () => {
  ...
  describe('Job Management', () => {
    ...
    it('should get all job statuses', async () => {
      ...
      const ourJobs = allStatuses.filter(s =>
        [job1.jobId, job2.jobId].includes(s.jobId)
      )
