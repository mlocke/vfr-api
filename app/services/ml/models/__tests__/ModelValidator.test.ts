...
describe('ModelValidator', () => {
  ...
  describe('validateModelConfig', () => {
    ...
    it('should reject config with empty features array', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('Features array cannot be empty'))).toBe(true)
    })
  ...
  describe('validatePerformanceMetrics', () => {
    ...
    it('should reject metrics with low accuracy', () => {
      const metrics = createValidPerformanceMetrics()
      metrics.accuracy = 0.50 // Below 0.60 threshold
      ...
      expect(result.actualValues.accuracy).toBe(0.50)
    })
    ...
    it('should reject metrics with low recall', () => {
      const metrics = createValidPerformanceMetrics()
      metrics.recall = 0.50 // Below 0.55 threshold
    ...
    it('should reject metrics with low F1 score', () => {
      const metrics = createValidPerformanceMetrics()
      metrics.f1Score = 0.40 // Below 0.55 threshold
    ...
    it('should reject negative training loss', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('Training loss cannot be negative'))).toBe(true)
    })
    ...
    it('should reject negative validation loss', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('Validation loss cannot be negative'))).toBe(true)
    })
    ...
    it('should reject low validation accuracy', () => {
      const metrics = createValidPerformanceMetrics()
      metrics.validationAccuracy = 0.50 // Below 0.60 threshold
  ...
  describe('validateArtifactIntegrity', () => {
    it('should validate artifact with correct checksum', () => {
      ...
      const result = validator.validateArtifactIntegrity(filePath, checksum, 'test-model-001')
    ...
    it('should reject artifact with invalid checksum', () => {
      ...
      const result = validator.validateArtifactIntegrity(filePath, wrongChecksum, 'test-model-002')
    ...
    it('should warn when no checksum provided', () => {
      ...
      const result = validator.validateArtifactIntegrity(filePath, undefined, 'test-model-003')
    ...
    it('should handle file not found', () => {
      ...
      const result = validator.validateArtifactIntegrity(filePath, 'some_checksum', 'test-model-004')
    ...
    it('should detect empty files', () => {
      ...
      const result = validator.validateArtifactIntegrity(filePath, undefined, 'test-model-005')
    ...
    it('should verify file is readable', () => {
      ...
      const result = validator.validateArtifactIntegrity(filePath, undefined, 'test-model-006')
  ...
  describe('validateHyperparameters - LightGBM', () => {
    ...
    it('should reject LightGBM num_leaves out of range (too high)', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('num_leaves') && e.includes('exceeds maximum'))).toBe(true)
    ...
    it('should reject LightGBM num_leaves out of range (too low)', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('num_leaves') && e.includes('below minimum'))).toBe(true)
    })
    ...
    it('should reject LightGBM invalid learning_rate', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('learning_rate') && e.includes('exceeds maximum'))).toBe(true)
    })
  ...
  describe('validateHyperparameters - XGBoost', () => {
    ...
    it('should reject XGBoost max_depth out of range', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('max_depth') && e.includes('exceeds maximum'))).toBe(true)
    })
  ...
  describe('validateHyperparameters - LSTM', () => {
    ...
    it('should reject LSTM dropout out of range', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('dropout') && e.includes('exceeds maximum'))).toBe(true)
    })
    ...
    it('should reject LSTM missing required units parameter', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('units') && e.includes('missing'))).toBe(true)
    ...
    it('should reject LSTM missing required sequence_length parameter', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('sequence_length') && e.includes('missing'))).toBe(true)
    })
  ...
  describe('validateHyperparameters - Ensemble', () => {
    ...
    it('should reject Ensemble missing required model_count', () => {
      ...
      expect(result.isValid).toBe(false)
      expect(result.errors.some(e => e.includes('model_count') && e.includes('missing'))).toBe(true)
    })
  ...
  describe('validateLoadingTime', () => {
    ...
    it('should warn about loading approaching limit', async () => {
      ...
      const result = await validator.validateLoadingTime(approachingLimitLoad, 'approaching-model-001')
  ...
  describe('validateModelForDeployment', () => {
    ...
    it('should fail when performance check fails', async () => {
      const config = createValidModelConfig()
      config.performanceMetrics.accuracy = 0.40 // Below threshold
    ...
    it('should report multiple failures when multiple checks fail', async () => {
      const config = createValidModelConfig()
      config.performanceMetrics.accuracy = 0.40 // Fail performance
  ...
  describe('Custom Thresholds', () => {
    it('should allow updating validation thresholds', () => {
      ...
      expect(thresholds.minAccuracy).toBe(0.70)
    ...
    it('should apply custom thresholds to validation', () => {
      validator.updateThresholds({ minAccuracy: 0.80 })
