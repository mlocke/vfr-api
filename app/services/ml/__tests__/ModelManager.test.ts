...
describe('ModelManager', () => {
  ...
  describe('Model Status Management', () => {
    test('should update model status', async () => {
      ...
      expect(updateResult.data?.updatedAt).toBeGreaterThan(modelConfig.performanceMetrics.lastUpdated)
    })
  ...
  describe('Model Listing and Filtering', () => {
    ...
    test('should get active models for specific horizon', async () => {
      ...
      const oneDayModels = modelManager.getActiveModelsForHorizon(MLPredictionHorizon.ONE_DAY)
  ...
  describe('Performance Metrics Update', () => {
    test('should update model performance metrics', async () => {
      ...
      const updateResult = await modelManager.updateModelPerformance('perf-update-model', newMetrics)
