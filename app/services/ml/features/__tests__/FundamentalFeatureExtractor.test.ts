...
describe('FundamentalFeatureExtractor', () => {
  ...
  describe('Real API Integration Tests', () => {
    ...
    describe('Shareholder Return Features with Real Data', () => {
      it('should extract shareholder return features from real AAPL fundamental ratios', async () => {
        ...
        expect(features.shareholderReturn.dividendGrowthPotential).toBeGreaterThanOrEqual(0);
    ...
    describe('Data Completeness with Real Data', () => {
      it('should calculate data completeness for real AAPL fundamental ratios', async () => {
        ...
        console.log(`AAPL data completeness: ${(features.dataCompleteness * 100).toFixed(1)}%`);
      ...
      it('should calculate data completeness for real MSFT fundamental ratios', async () => {
        ...
        expect(features.dataCompleteness).toBeGreaterThanOrEqual(0);
        expect(features.dataCompleteness).toBeLessThanOrEqual(1);
        console.log(`MSFT data completeness: ${(features.dataCompleteness * 100).toFixed(1)}%`);
      }, 30000);
      ...
      it('should calculate data completeness for real GOOGL fundamental ratios', async () => {
        ...
        expect(features.dataCompleteness).toBeGreaterThanOrEqual(0);
        expect(features.dataCompleteness).toBeLessThanOrEqual(1);
        console.log(`GOOGL data completeness: ${(features.dataCompleteness * 100).toFixed(1)}%`);
      }, 30000);
    });
  });
  ...
  describe('Valuation Features - Detailed Logic Tests', () => {
    it('should calculate valuation score correctly for expensive stock', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('EXPENSIVE', expensiveRatios);
    ...
    it('should handle missing valuation ratios with defaults', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('INCOMPLETE', incompleteRatios);
  ...
  describe('Profitability Features - Detailed Logic Tests', () => {
    it('should identify high quality company correctly', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('QUALITY', highQualityRatios);
    ...
    it('should identify low quality company correctly', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('LOWQUALITY', lowQualityRatios);
    ...
    it('should calculate profitability score correctly for excellent company', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('EXCELLENT', excellentRatios);
    ...
    it('should handle negative profitability metrics', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('UNPROFITABLE', unprofitableRatios);
  ...
  describe('Financial Health Features - Detailed Logic Tests', () => {
    it('should identify financially stressed company', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('STRESSED', stressedRatios);
    ...
    it('should calculate leverage risk correctly', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('HIGHDEBT', highDebtRatios);
  ...
  describe('Shareholder Return Features - Detailed Logic Tests', () => {
    ...
    it('should calculate dividend sustainability correctly for optimal payout', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('SUSTAINABLE', sustainableRatios);
    ...
    it('should calculate dividend sustainability correctly for high payout', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('HIGHPAYOUT', highPayoutRatios);
    ...
    it('should calculate dividend growth potential correctly', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('GROWTH', growthPotentialRatios);
  ...
  describe('Data Completeness Calculation', () => {
    it('should calculate 100% completeness for fully populated ratios', () => {
      ...
      const features = FundamentalFeatureExtractor.extractFeatures('COMPLETE', completeRatios);
  ...
  describe('Performance Requirements', () => {
    ...
    it('should handle batch extraction efficiently', () => {
      ...
      console.log(`Average extraction time: ${avgTime.toFixed(2)}ms (${testSymbols.length} symbols)`);
  ...
  describe('Feature Consistency', () => {
    it('should produce consistent results for same input', () => {
      ...
      expect(features1.profitability.profitabilityScore).toBe(features2.profitability.profitabilityScore);
      expect(features1.financialHealth.healthScore).toBe(features2.financialHealth.healthScore);
    ...
    it('should ensure healthScore reflects leverage and liquidity correctly', () => {
      ...
      const expectedHealth = (1 - features.financialHealth.leverageRisk + features.financialHealth.liquidityStrength) / 2;
