...
describe('TechnicalFeatureExtractor', () => {
  ...
  describe('Feature Flattening', () => {
    ...
    it('should preserve feature values in flattened format', () => {
      ...
      expect(flatFeatures['adv_price_zscore_20d']).toBe(features.meanReversion.priceZScore20d);
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle data with zero prices', () => {
      const ohlcData: OHLCData[] = [
        ...
        { timestamp: Date.now(), open: 100, high: 100, low: 100, close: 100, volume: 1000000 }
      ];
