...
describe('EarlySignalFeatureExtractor - Comprehensive Test Suite', () => {
  ...
  describe('Category 1: Individual Feature Validation', () => {
    ...
    describe('Momentum Features (3 features)', () => {
      it('should_calculate_price_change_5d_correctly', async () => {
        ...
        console.log(`  ✓ price_change_5d (AAPL): ${(features.price_change_5d * 100).toFixed(2)}%`)
      }, 10000)
      ...
      it('should_calculate_price_change_10d_correctly', async () => {
        ...
        console.log(`  ✓ price_change_10d (TSLA): ${(features.price_change_10d * 100).toFixed(2)}%`)
      }, 10000)
      ...
      it('should_calculate_price_change_20d_correctly', async () => {
        ...
        console.log(`  ✓ price_change_20d (NVDA): ${(features.price_change_20d * 100).toFixed(2)}%`)
      }, 10000)
      ...
      it('should_show_momentum_progression_for_trending_stock', async () => {
        ...
        console.log(`  ✓ Momentum progression (NVDA): 5d=${(features.price_change_5d * 100).toFixed(2)}%, 10d=${(features.price_change_10d * 100).toFixed(2)}%, 20d=${(features.price_change_20d * 100).toFixed(2)}%`)
      }, 10000)
    })
    ...
    describe('Volume Features (2 features)', () => {
      ...
      it('should_detect_volume_anomalies_in_high_volume_stocks', async () => {
        ...
        console.log(`  ✓ Volume features (SPY): ratio=${features.volume_ratio.toFixed(3)}, trend=${features.volume_trend.toFixed(2)}`)
      }, 10000)
    })
    ...
    describe('Sentiment Features (3 features)', () => {
      it('should_extract_sentiment_news_delta', async () => {
        ...
        console.log(`  ✓ sentiment_news_delta (TSLA): ${features.sentiment_news_delta.toFixed(3)}`)
      }, 10000)
      ...
      it('should_extract_sentiment_reddit_accel', async () => {
        ...
        console.log(`  ✓ sentiment_reddit_accel (TSLA): ${features.sentiment_reddit_accel.toFixed(3)}`)
      }, 10000)
      ...
      it('should_extract_sentiment_options_shift', async () => {
        ...
        console.log(`  ✓ sentiment_options_shift (AAPL): ${features.sentiment_options_shift.toFixed(3)}`)
      }, 10000)
      ...
      it('should_handle_missing_sentiment_data_gracefully', async () => {
        ...
        console.log(`  ✓ Sentiment features (PLTR): news=${features.sentiment_news_delta.toFixed(3)}, reddit=${features.sentiment_reddit_accel.toFixed(3)}, options=${features.sentiment_options_shift.toFixed(3)}`)
      }, 10000)
    })
    ...
    describe('Fundamental Features (3 features)', () => {
      it('should_calculate_earnings_surprise_percentage', async () => {
        ...
        console.log(`  ✓ earnings_surprise (AAPL): ${features.earnings_surprise.toFixed(2)}%`)
      }, 10000)
      ...
      it('should_calculate_revenue_growth_acceleration', async () => {
        ...
        console.log(`  ✓ revenue_growth_accel (NVDA): ${features.revenue_growth_accel.toFixed(2)} pp`)
      }, 10000)
      ...
      it('should_calculate_analyst_coverage_change', async () => {
        ...
        console.log(`  ✓ analyst_coverage_change (TSLA): ${features.analyst_coverage_change.toFixed(0)}`)
      }, 10000)
      ...
      it('should_handle_missing_fundamental_data_gracefully', async () => {
        ...
        console.log(`  ✓ Fundamental features (ARKK): earnings=${features.earnings_surprise.toFixed(2)}%, revenue=${features.revenue_growth_accel.toFixed(2)}, analysts=${features.analyst_coverage_change.toFixed(0)}`)
      }, 10000)
    })
    ...
    describe('Technical Features (2 features)', () => {
      ...
      it('should_calculate_macd_histogram_trend', async () => {
        ...
        console.log(`  ✓ macd_histogram_trend (NVDA): ${features.macd_histogram_trend.toFixed(4)}`)
      }, 10000)
      ...
      it('should_handle_missing_technical_data_gracefully', async () => {
        ...
        console.log(`  ✓ Technical features (PLTR): rsi=${features.rsi_momentum.toFixed(2)}, macd=${features.macd_histogram_trend.toFixed(4)}`)
      }, 10000)
    })
  })
  ...
  describe('Category 4: Performance Requirements', () => {
    ...
    it('should_complete_feature_extraction_in_under_5_seconds_for_AAPL', async () => {
      ...
      console.log(`  ✓ AAPL extraction completed in ${duration}ms (target: <${LATENCY_TARGET}ms)`)
    }, 10000)
    ...
    it('should_complete_feature_extraction_in_under_5_seconds_for_TSLA', async () => {
      ...
      console.log(`  ✓ TSLA extraction completed in ${duration}ms (target: <${LATENCY_TARGET}ms)`)
    }, 10000)
    ...
    it('should_complete_feature_extraction_in_under_5_seconds_for_NVDA', async () => {
      ...
      console.log(`  ✓ NVDA extraction completed in ${duration}ms (target: <${LATENCY_TARGET}ms)`)
    }, 10000)
    ...
    it('should_measure_average_extraction_time_across_10_calls', async () => {
      ...
      console.log(`  ✓ Average extraction time: ${avgDuration.toFixed(0)}ms (min: ${minDuration}ms, max: ${maxDuration}ms)`)
    }, 60000)
  })
