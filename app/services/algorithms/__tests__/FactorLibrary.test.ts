...
describe('FactorLibrary - Real Data Integration', () => {
  ...
  describe('Composite Score Calculations', () => {
    ...
    test('should handle momentum_composite calculation', async () => {
      ...
      if (momentumScore !== null) {
        ...
        console.log('ℹ️ Momentum composite returned null (expected in test environment without historical data)')
      }
    })
  })
  ...
  describe('Data Validation and Edge Cases', () => {
    test('should handle missing fundamental data gracefully', async () => {
      ...
      if (qualityScore !== null) {
        ...
        expect(qualityScore).toBeGreaterThanOrEqual(0)
        expect(qualityScore).toBeLessThanOrEqual(1)
        console.log(`✅ Handles sparse fundamental data gracefully → ${qualityScore.toFixed(4)}`)
      } else {
  ...
  describe('Performance and Caching', () => {
    test('should cache factor calculations', async () => {
      ...
      console.log(`✅ Cache performance: First call: ${firstCallTime}ms, Cached call: ${secondCallTime}ms`)
  ...
  describe('Real-World Data Processing', () => {
    test('should demonstrate TSLA factor profile', async () => {
      ...
      const factors = {
        pe_ratio: await factorLibrary.calculateFactor('pe_ratio', 'TSLA', tslaMarketData, tslaFundamentalData),
        pb_ratio: await factorLibrary.calculateFactor('pb_ratio', 'TSLA', tslaMarketData, tslaFundamentalData),
        roe: await factorLibrary.calculateFactor('roe', 'TSLA', tslaMarketData, tslaFundamentalData),
        debt_equity: await factorLibrary.calculateFactor('debt_equity', 'TSLA', tslaMarketData, tslaFundamentalData),
        current_ratio: await factorLibrary.calculateFactor('current_ratio', 'TSLA', tslaMarketData, tslaFundamentalData),
        quality_composite: await factorLibrary.calculateFactor('quality_composite', 'TSLA', tslaMarketData, tslaFundamentalData),
        value_composite: await factorLibrary.calculateFactor('value_composite', 'TSLA', tslaMarketData, tslaFundamentalData)
      }
