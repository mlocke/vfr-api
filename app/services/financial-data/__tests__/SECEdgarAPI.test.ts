...
import { StockData, CompanyInfo, MarketData, InstitutionalHolding, InsiderTransaction, InstitutionalSentiment, InsiderSentiment } from '../types'
...
describe('SECEdgarAPI', () => {
  ...
  describe('Rate Limiting and SEC Compliance', () => {
    ...
    test('should_maintain_request_delay_consistency', async () => {
      ...
      const delays = requestStartTimes.slice(1).map((time, index) => time - requestStartTimes[index])
