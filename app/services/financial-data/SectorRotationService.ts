...
export class SectorRotationService {
  ...
  async getAllSectorPerformances(): Promise<SectorPerformance[]> {
    try {
      ...
      throw this.errorHandler.errorHandler.createErrorResponse(error, 'getAllSectorPerformances')
    }
  }
  ...
  async getSectorRecommendations(): Promise<{ buy: string[]; sell: string[]; hold: string[] }> {
    try {
      ...
      throw this.errorHandler.errorHandler.createErrorResponse(error, 'getSectorRecommendations')
    }
  }
