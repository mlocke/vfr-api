...
import {
	MarketSentimentData,
	SectorSentiment,
} from "../../services/financial-data/MarketSentimentService";
		...
		return (
			<div className={`market-sentiment-heatmap ${className}`}>
				<div className="error-container">
					...
					<button onClick={fetchSentimentData} className="retry-button">
						Retry
					</button>
				</div>
		...
		<div className={`market-sentiment-heatmap ${className}`}>
				...
				<div className="sentiment-overview">
					...
					>
						...
						<span className="sentiment-label">
							{sentimentData.overall.level.replace("-", " ").toUpperCase()}
						</span>
					</div>
					<button
			...
			<div className="heatmap-grid">
				...
				{sentimentData.sectors.map(sector => (
					<div
						...
						title={
							isLimitedData(sector)
								? "Limited data available due to API rate limits"
								: `${sector.name} sector sentiment`
						}
					>
						<div className="card-header">
				...
				<div
					...
					style={{
						background: getSentimentColor(
							sentimentData.economicIndicators.yieldCurve.value,
							true
						),
						borderColor: getSentimentColor(
							sentimentData.economicIndicators.yieldCurve.value
						),
						boxShadow: getSentimentGlow(
							sentimentData.economicIndicators.yieldCurve.value
						),
					}}
				>
					...
					<div className="card-value">
						{sentimentData.economicIndicators.yieldCurve.spread10Y2Y !== undefined
							? formatPercentage(
									sentimentData.economicIndicators.yieldCurve.spread10Y2Y
								)
			...
			<div className="heatmap-footer">
				<div className="data-quality">
					...
					{sentimentData.dataQuality < 0.5 && (
						<span className="quality-warning"> (Limited due to API constraints)</span>
					)}
				</div>
