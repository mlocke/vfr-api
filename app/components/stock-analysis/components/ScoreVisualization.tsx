...
const ScoreVisualization: React.FC<ScoreVisualizationProps> = ({ scores, symbol }) => {
	...
	return (
		<>
			...
			<section className="score-container" aria-labelledby="scores-heading">
				<div className="score-grid">
					...
					<div className="breakdown-container">
						<h3 className="breakdown-title" id="scores-heading">
							Score Breakdown
						</h3>
						...
						<div role="list" aria-label="Score categories">
							{scoreCategories.map((category, index) => (
								<div key={category.label} role="listitem">
									<HorizontalBar category={category} index={index} />
								</div>
							))}
						</div>
						...
						>
							...
							>
								<div style={{ marginBottom: "0.25rem" }}>
									<span style={{ color: "rgba(0, 200, 83, 0.8)" }}>80+</span>{" "}
									Excellent
									<span
										style={{
											margin: "0 0.5rem",
