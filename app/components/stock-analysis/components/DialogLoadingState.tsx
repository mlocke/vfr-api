    ...
    <>
      ...
      >
        ...
        >
          ...
          {stage === 'fetching' && (
            <div>
              We analyze data from 15+ sources including SEC filings,
              real-time market data, and sentiment indicators.
            </div>
          )}
          {stage === 'analyzing' && (
            <div>
              Our AI engine processes technical, fundamental, macro,
              and sentiment factors to generate comprehensive scores.
            </div>
          )}
          {stage === 'processing' && (
            <div>
              Final recommendations combine multiple analysis layers
              with confidence scoring for informed decisions.
            </div>
          )}
        </div>
