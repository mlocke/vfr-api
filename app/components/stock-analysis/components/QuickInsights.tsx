...
const generateInsights = (stockData: DialogStockData): Insight[] => {
  ...
  insights.push({
    ...
    icon: '💡',
    category: 'Analysis',
    details: stockData.reasoning.primaryFactors.length > 0
      ? stockData.reasoning.primaryFactors
      : ['Comprehensive multi-factor analysis', 'Market data integration', 'Risk-adjusted scoring']
  })
    ...
    <>
      ...
      >
        ...
        <div
          ...
          role="list"
          aria-label="Stock analysis insights"
        >
