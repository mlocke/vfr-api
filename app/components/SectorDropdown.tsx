...
const MARKET_SECTORS: SectorOption[] = [
	...
	},
	{
		id: "industrials",
		label: "Industrials",
		description: "Manufacturing, aerospace, defense",
		category: "sector",
	},
	{
		id: "utilities",
	...
	},
	{
		id: "materials",
		label: "Materials",
		description: "Mining, chemicals, forestry",
		category: "sector",
	},
	{
		id: "real-estate",
	...
	// Exchange Traded Funds
	{
		id: "etfs",
		label: "Popular ETFs",
		description: "Most traded ETFs and leveraged funds",
		category: "etf",
	},
];
...
export default function SectorDropdown({
	...
	return (
		<div
			className={`${styles.container} ${isOpen ? styles.active : ""} sector-dropdown`}
			ref={dropdownRef}
		>
