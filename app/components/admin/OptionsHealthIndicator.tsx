...
export default function OptionsHealthIndicator({
  ...
  const [currentStatus, setCurrentStatus] = useState<OptionsHealthStatus | null>(healthStatus || null);
  ...
  const getOverallStatusColor = (status: string) => {
    switch (status) {
      case 'healthy': return 'rgba(34, 197, 94, 0.8)';
      case 'degraded': return 'rgba(251, 191, 36, 0.8)';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {Object.entries(status.providers.unicornbay.features).map(([feature, available]) => (
            <div
              key={feature}
              style={{
                display: "flex",
                alignItems: "center",
                gap: "0.25rem",
                color: available ? "rgba(34, 197, 94, 0.8)" : "rgba(239, 68, 68, 0.8)",
              }}
            >
              {available ? '✅' : '❌'}
        ...
        >
          ...
          <div
            style={{
              fontSize: "0.8rem",
              fontWeight: "600",
              color: status.cache.hitRatio >= 85 ? "rgba(34, 197, 94, 0.8)" : "rgba(251, 191, 36, 0.8)",
            }}
          >
        ...
        >
          ...
          <div
            style={{
              fontSize: "0.8rem",
              fontWeight: "600",
              color: status.system.memoryUsage < 80 ? "rgba(34, 197, 94, 0.8)" : "rgba(239, 68, 68, 0.8)",
            }}
          >
        ...
        >
          ...
          <div
            style={{
              fontSize: "0.8rem",
              fontWeight: "600",
              color: status.system.cpuUsage < 70 ? "rgba(34, 197, 94, 0.8)" : "rgba(239, 68, 68, 0.8)",
            }}
          >
