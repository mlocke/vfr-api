...
export default function OptionsFeatureMatrix({ featureMatrix }: OptionsFeatureMatrixProps) {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'basic': return 'rgba(34, 197, 94, 0.8)';
      case 'advanced': return 'rgba(251, 191, 36, 0.8)';
      case 'premium': return 'rgba(168, 85, 247, 0.8)';
  ...
  return (
    <div>
              ...
              {categoryFeatures.map(feature => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      📈 {feature.standardAvailable ? '✅ Available' : '❌ Not Available'}
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      🦄 {feature.unicornbayAvailable ? '✅ Enhanced' : '❌ Not Available'}
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      {getDataQualityIcon(feature.dataQuality)} {feature.dataQuality}
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      {getPerformanceIcon(feature.performanceImpact)} {feature.performanceImpact}
                    </div>
                    <div
                      style={{
                        display: "flex",
      ...
      >
        ...
        >
          <div>
            <div style={{ fontWeight: "600", marginBottom: "0.25rem" }}>Data Quality:</div>
            <div>🔵 Basic • 🟡 Enhanced • 🟢 Institutional</div>
          </div>
          <div>
            <div style={{ fontWeight: "600", marginBottom: "0.25rem" }}>Performance Impact:</div>
            <div>🟢 Low • 🟡 Medium • 🔴 High</div>
          </div>
          <div>
            <div style={{ fontWeight: "600", marginBottom: "0.25rem" }}>Provider Status:</div>
            <div>🟢 Online • 🟡 Degraded • 🔴 Offline</div>
          </div>
          <div>
            <div style={{ fontWeight: "600", marginBottom: "0.25rem" }}>Categories:</div>
