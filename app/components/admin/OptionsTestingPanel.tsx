...
export default function OptionsTestingPanel({ onTestComplete }: OptionsTestingPanelProps) {
	...
	const [activeTab, setActiveTab] = useState<"config" | "results" | "charts" | "errors">(
		"config"
	);
	...
	return (
		...
		>
			...
			<div style={{ minHeight: "600px" }}>
							...
							>
									...
									<select
										...
										onChange={e =>
											setTestConfig(prev => ({
												...prev,
												testType: e.target
													.value as OptionsTestConfig["testType"],
											}))
										}
										style={{
											width: "100%",
									...
									>
										...
										<button
											...
											style={{
												padding: "0.75rem",
												background:
													testConfig.provider === "unicornbay"
														? "rgba(168, 85, 247, 0.3)"
														: "rgba(255, 255, 255, 0.1)",
												border:
													testConfig.provider === "unicornbay"
								...
								>
									{isRunning ? (
										...
										<>
											{getTestTypeIcon(testConfig.testType)} Run{" "}
											{testConfig.testType} Test
				...
				{activeTab === "charts" && <OptionsPerformanceChart testResults={testResults} />}

				{activeTab === "errors" && <OptionsErrorLog testResults={testResults} />}
			</div>
