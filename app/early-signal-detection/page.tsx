			...
			<footer className="bg-slate-900 border-t border-slate-700/50 py-12">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<h3 className="text-3xl font-bold bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent mb-4">
						Ready to Try Early Signal Detection?
					</h3>
					<p className="text-slate-100 text-lg mb-8 max-w-2xl mx-auto">
						Access AI-powered analyst rating predictions through VFR's Stock
						Intelligence platform. Position your portfolio before the market reacts.
					</p>
					<Link
						href="/stock-intelligence"
